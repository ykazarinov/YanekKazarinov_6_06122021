class photographerTemplate{
    ...
    getUserCardDOM(){
        ...
        article.id = this.id
        let content = `
        <a href="photographer.html?id=${article.id}&name=${this.name}"><img class="img_link" alt="${this.name}" src="assets/photographers/${this.portrait}"></a>
        <h2><a class="title_link" href="photographer.html?id=${article.id}&name=${this.name}">${this.name}</a></h2>
        <div class="infoPlus">
